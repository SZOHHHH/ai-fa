...
## 5. 与前作/矩阵关系
- 线锚：[混合专家（MoE）](/ai-fa/explore/20-Algorithms/混合专家（MoE）) · [MoE门控公式](/ai-fa/explore/30-Formulas/MoE门控公式)（静态参数银行→在线生成权重的对照基准）
- 同族：↔ [DeepSeekMoE](/ai-fa/explore/10-Papers/05-MoE/DeepSeekMoE- Towards Ultimate Expert Specialization in Mixture-of-Experts Language Model（DeepSeekMoE）)（静态专家池的极致专业化 vs 本卡活数据生成专家）· [LoRA分解](/ai-fa/explore/30-Formulas/LoRA分解)（权重生成/适配的低秩视角，260918 处理段挂链，占位层待精读）
