...
流式 AR 扩散（[[10-Papers/09-世界模型与JEPA/Diffusion Forcing- Next-token Prediction Meets Full-Sequence Diffusion（Diffusion Forcing）]]）；上下文记忆与误差漂移（对比我们的 E1_实验数据台账 尸检节）。
