...
> 近邻同族：[Co-Evolving Latent Action World Models](/explore/10-Papers/09-世界模型与JEPA/Co-Evolving Latent Action World Models（CoLA）) · [Hierarchical Planning with Latent World Models](/explore/10-Papers/09-世界模型与JEPA/Hierarchical Planning with Latent World Models（HPLWM）)
