...
## 5. 与前作/矩阵关系
- 线锚：[混合专家（MoE）](/ai-fa/explore/20-Algorithms/混合专家（MoE）) · [MoE门控公式](/ai-fa/explore/30-Formulas/MoE门控公式)（多视角统一的关键件）
- 同族：↔ [VL2](/ai-fa/explore/10-Papers/05-MoE/DeepSeek-VL2- Mixture-of-Experts Vision-Language Models for Advanced Multimodal Understanding（VL2）)（MoE×视觉语言家族）· [CLIP对比损失](/ai-fa/explore/30-Formulas/CLIP对比损失)（视觉语言重排序的表征基底，260918 处理段挂链，占位层待精读）
