...
## 5. 与前作/矩阵关系
- 线锚：[[20-Algorithms/Transformer]] · [[30-Formulas/注意力核心公式]]
- 同族：[[10-Papers/01-架构演进/Graph Attention Networks（GAT）|GAT]]（结构/关系信息的注意力路由同源思想） · [[10-Papers/01-架构演进/RoFormer- Enhanced Transformer with Rotary Position Embedding（RoPE）|RoPE]]（其 RoPE 式符号检索=免学习的相对符号机制，零参数匹配学习符号库）
- 概念链：[[40-Concepts/注意力机制]] · [[30-Formulas/RoPE旋转位置编码]]
