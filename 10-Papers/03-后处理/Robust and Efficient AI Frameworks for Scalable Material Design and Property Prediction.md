...
## 5. 与前作/矩阵关系
- 线锚：[[40-Concepts/知识蒸馏]]（CrysGNN：大规模自监督图预训练知识经蒸馏转移到下游属性预测器）· [[20-Algorithms/变分自编码器]]（CrysXPP 无监督图自编码学可迁移晶体表征）· [[20-Algorithms/扩散模型]]（TGDMat 文本引导联合扩散：晶格+原子类型+坐标共去噪）
