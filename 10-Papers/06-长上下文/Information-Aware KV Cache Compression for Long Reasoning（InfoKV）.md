...
> 近邻同族（续，260919）：[[10-Papers/06-长上下文/ASPIRE Asynchronous Batched Self-Speculative Decoding for Long-Context LLM Inference|ASPIRE]]（解码内存墙另一轴：不压 KV、用异步批式自投机解码摊薄全量 KV 读）
> 数学根基（占位层）：[[KV缓存]]
