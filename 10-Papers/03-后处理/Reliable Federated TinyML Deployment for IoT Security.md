...
- ≡压缩部署同族 [[DistilBERT, a distilled version of BERT- smaller, faster, cheaper and lighter（DistilBERT）]]：同是"大模型能力→小设备"的迁移，此处叠加联邦维度
- ↔[[40-Concepts/量化]]：TinyML 压缩工具箱的核心件
- ↔[[40-Concepts/知识蒸馏]]：压缩手段谱系中的一员（与量化/剪枝并列）
...
- 联邦学习基本流程（本地训练+服务端聚合）与 [[40-Concepts/量化]] 概念
