...
- ←[Distilling the Knowledge in a Neural Network](/ai-fa/explore/10-Papers/03-后处理/Distilling the Knowledge in a Neural Network（KD）)（综述所梳理谱系的源头）
- ≡同族综述对象 [DistilBERT, a distilled version of BERT - smaller, faster, cheaper and lighter](/ai-fa/explore/10-Papers/03-后处理/DistilBERT, a distilled version of BERT- smaller, faster, cheaper and lighter（DistilBERT）)：预训练模型压缩是综述中"高容量教师"的典型来源
- ↔[知识蒸馏](/ai-fa/explore/40-Concepts/知识蒸馏)：本卡是"KD×网络域"的应用综述支线，无算法创新
...
- 先掌握 [知识蒸馏](/ai-fa/explore/40-Concepts/知识蒸馏) 基本范式（教师/学生/暗知识）
