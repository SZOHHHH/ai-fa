...
- → 后继补记（260924）：[LoT 课程蒸馏](/ai-fa/explore/10-Papers/03-后处理/Ladders of Thought A Self-Evolving Curriculum of Progressively Simplified Reasoning Traces)（同一痛点"中小模型蒸馏后仍推理脆"的另一答案：不改目标构造，改数据组织——问题改写降难+bandit 自进化课程）
