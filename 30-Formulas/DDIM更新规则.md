...
**第 2 步：η=0（确定性 DDIM）。** $\sigma = 0$：$x_1 = 0.995\times2.000 + \sqrt{0.01}\times0.5 + 0 = 1.990+0.050 = 2.040$——三项只剩前两项，**无抽签恒为此值**（= PF-ODE 欧拉步，[[30-Formulas/概率流ODE]] 同数）。

**第 3 步：η=1（还原 DDPM 祖先采样）。** $\sigma_1 = \sqrt{\frac{0.01}{0.0298}}\times\sqrt{1-\frac{0.9702}{0.99}} = 0.579\times0.141 = 0.0819$；方向项系数缩为 $\sqrt{0.01 - 0.0819^2} = \sqrt{0.0033} = 0.0574$。$x_1 = 1.990 + 0.0574\times0.5 + 0.0819\,z = 2.019 + 0.0819\,z$——对照 [[30-Formulas/DDPM后验分布]]：均值方差**双双吻合**（后验均值 2.019、$\sqrt{\tilde\beta} = 0.082$）。
