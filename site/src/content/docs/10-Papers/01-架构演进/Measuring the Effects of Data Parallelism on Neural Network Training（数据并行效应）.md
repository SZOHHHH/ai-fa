...
**直觉**：← [Scaling Laws for Neural Language Models](/ai-fa/explore/10-Papers/01-架构演进/Scaling Laws for Neural Language Models（Scaling Laws）)（库内）的工程侧；→ 大规模训练配方（zero redundancy 系）
