...
- 同族：[[10-Papers/01-架构演进/A Systematic Analysis of Hybrid Linear Attention（混合线性分析）|混合线性分析]]（混合注意力-线性/RNN 骨干的系统分析谱系） · [[10-Papers/01-架构演进/Jamba- A Hybrid Transformer-Mamba Language Model（Jamba）|Jamba]]（注意力+SSM 混合先行者——本文换成注意力+RNN 且反向用于双向化）
- 概念链：[[40-Concepts/稀疏与线性注意力]]（混合架构线性侧的语境） · [[40-Concepts/马尔可夫链]]（RNN 层=隐状态马尔夫递归，双向化难点所在）
