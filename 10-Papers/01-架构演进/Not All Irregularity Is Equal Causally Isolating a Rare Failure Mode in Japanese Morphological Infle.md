...
- 同族：[[10-Papers/01-架构演进/BERT- Pre-training of Deep Bidirectional Transformers for Language Understanding（BERT）|BERT]]（字符/词法级 NLP 建模谱系，双向编码的语言学评估传统） · [[10-Papers/01-架构演进/Attention Is All You Need（Transformer）|Transformer]]
